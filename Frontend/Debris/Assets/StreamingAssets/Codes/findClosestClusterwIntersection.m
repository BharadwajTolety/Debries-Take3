function [ Benefit, cluster_add, collection] = findClosestClusterwIntersection( node, Contractor, con, TimeMatrix, coll_debris,...
...
[ dist, ~ ] = dijkstra( TimeMatrix, node, (1:no_nodes));
