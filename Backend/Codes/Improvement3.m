function [ Contractor ] = Improvement3( Contractor, i ,nc)
...
for r=1:no_trips  % Create Q1 and Q2
    if Contractor{nc}.trips{1,i}{r,4} > 0; 
        Q_Empty=[Q_Empty,r]; 
        Q_swap=setdiff(Q2_original,Q_Empty(1));  %The rest goes to Q2  - just for 1 non-empty trip for the rest of Q1 ; its associated Q2 is calculated later    
    end;
